...
echo -e "╭━━┳╮╭┳┫┣╯┃┃┣┻┳╮╭┳━┻╮╭╯"
sleep 0.05
echo -e "┃┃━┫╰╯┣┫┃╱┃┃┃╭┫┃┃┃━━┫┃   ${endColour}${yellowColour}(${endColour}${grayColour}Hecho por ${endColour}${blueColour}@H4kking - ${endColour}${purpleColour}Eso le metes un nmap y pa' dentro${endColour}${yellowColour})${endColour}${redColour}"
sleep 0.05
echo -e "┃┃━╋╮╭┫┃╰╮┃┃┃┃┃╰╯┣━━┃╰╮"
sleep 0.05
echo -e "╰━━╯╰╯╰┻━╯╰╯╰╯╰━━┻━━┻━╯${endColour}"
...
function startAttack(){
	...
	echo -ne "${yellowColour}[*]${endColour}${grayColour} Plantilla a utilizar (CFE):${endColour} " && read template
...
function guiMode(){
	whiptail --title "evilTrust - by S4vitar" --msgbox "Bienvenido a evilTrust." 8 78
	...
	rm iface 2>/dev/null
	use_ssid=$(whiptail --inputbox "Introduce el nombre del punto de acceso a utilizar (Ej: CFE):" 8 78 --title "evilTrust - by S4vitar" 3>&1 1>&2 2>&3)
	...
	whiptail --title "evilTrust - by @H4kkingr" --msgbox "Perfecto, voy a crearte unos archivos de configuración para desplegar el ataque..." 8 78
